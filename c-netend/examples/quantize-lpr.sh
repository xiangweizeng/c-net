...
./tools/calibration --param=models/plate/lpr-opt.param \
          --bin=models/plate/lpr-opt.bin \
          --images=images/plate-images/ \
...
./tools/calibration --param=models/plate/lpc-opt.param \
...
./tools/calibration \
          --param=models/plate/plate-opt.param \
          --bin=models/plate/plate-opt.bin \
          --images=images/plate-detector \
          --output=models/plate/plate-opt.table \
          --size=320,240 \
