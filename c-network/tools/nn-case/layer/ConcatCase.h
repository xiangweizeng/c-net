...
#ifndef CNET_CONCATCASE_H
#define CNET_CONCATCASE_H

#include "../CNetLayerCase.h"

class ConcatCase : public CNetLayerCase{
public:
    ConcatCase(CNetCase* network, ncnn::Layer *layer);
