...
#ifndef CNET_ELT_WISE_CASE_H
#define CNET_ELT_WISE_CASE_H

#include "../CNetLayerCase.h"


class EltwiseCase : public CNetLayerCase{
public:
    EltwiseCase(CNetCase *network, ncnn::Layer *layer);
