...
#ifndef CNET_MEMORY_DATA_CASE_H
#define CNET_MEMORY_DATA_CASE_H


#include "../CNetLayerCase.h"

class MemoryDataCase : public CNetLayerCase{
public:
    MemoryDataCase(CNetCase *network, ncnn::Layer *layer);
