...
#ifndef CNET_PRELU_CASE_H
#define CNET_PRELU_CASE_H

#include "../CNetLayerCase.h"

class PReLUCase : public CNetLayerCase{
public:
    PReLUCase(CNetCase *network, ncnn::Layer *layer);
