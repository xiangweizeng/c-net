...
#ifndef CNET_PADDING_CASE_H
#define CNET_PADDING_CASE_H

#include "../CNetLayerCase.h"

class PaddingCase : public CNetLayerCase{
public:
    PaddingCase(CNetCase *network, ncnn::Layer *layer);
