...
#ifndef CNET_PERMUTE_CASE_H
#define CNET_PERMUTE_CASE_H

#include "../CNetLayerCase.h"

class PermuteCase : public CNetLayerCase{
public:
    PermuteCase(CNetCase* network, ncnn::Layer *layer);
