...
#ifndef CNET_RESHAPE_CASE_H
#define CNET_RESHAPE_CASE_H

#include "../CNetLayerCase.h"

class ReshapeCase : public CNetLayerCase{
public:
    ReshapeCase(CNetCase* network, ncnn::Layer *layer);
