...
#ifndef CNET_SIGMOID_CASE_H
#define CNET_SIGMOID_CASE_H

#include "../CNetLayerCase.h"

class SigmoidCase : public CNetLayerCase{
public:
    SigmoidCase(CNetCase *network, ncnn::Layer *layer);
