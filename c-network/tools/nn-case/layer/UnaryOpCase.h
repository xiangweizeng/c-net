...
#ifndef CNET_UNARY_OP_CASE_H
#define CNET_UNARY_OP_CASE_H

#include "../CNetLayerCase.h"

class UnaryOpCase : public CNetLayerCase{
public:
    UnaryOpCase(CNetCase *network, ncnn::Layer *layer);
